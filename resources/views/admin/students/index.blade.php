...
<div class="bg-indigo-900 text-center py-4 lg:px-4">
    ...
    <div class="p-2 bg-indigo-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex"
        ...
        <a class="rounded text-white font-bold bg-teal-500 p-1" href="{{url('deliver',$item->data['action'])}}">
...
<div class="flex flex-wrap">
    <div
        class="w-full mx-2 text-white card bg-gradient-green rounded-sm font-montserrat md:w-5/12 flex p-5 justify-between mt-5 items-center">
        <div>
    ...
    <div
        class="w-full mx-2 text-white card bg-gradient-red rounded-sm font-montserrat md:w-5/12 flex p-5 justify-between mt-5 items-center">

        <div>
            <svg aria-hidden="true" data-prefix="fas" data-icon="briefcase"
                class="h-12 w-12 svg-inline--fa fa-briefcase fa-w-16" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512">
                <path fill="currentColor"
